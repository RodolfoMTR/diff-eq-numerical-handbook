...
Sea crea un nuevo programa con el nombre de \textbf{bashfordos11.m}
...
\textbf{Manual:}
\begin{itemize}
    \item Abrir el archivo \textbf{bashfordos11.m} en Matlab/Octave.
...
a=0;b=1;n=4;k=1;%k=1 porque es de orden 2
    ...
    \item Ejecutar el script con el comando \textbf{bashfordos11} en la consola de Matlab/Octave.
\end{itemize}
